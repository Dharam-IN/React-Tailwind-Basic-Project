...
const Header = () => {
  ...
  return (
    <div className='sticky top-0 h-14 z-10 flex flex-row items-center bg-white dark:bg-black flex-row justify-between px-4 md:px-4'>
      {loading && <Loader/>}
        ...
        <div className="flex items-center">
          <div className="hidden md:flex">
            ...
            <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
              <img src={DharamProfile} alt="image" />
            </div>
          </div>
        </div>
    </div>
